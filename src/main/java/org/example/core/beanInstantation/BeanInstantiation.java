package org.example.core.beanInstantation;

import org.example.core.beanInstantation.model.Client;
...
public class BeanInstantiation {
    ...
    public static void main(String[] args) {
        ...
        new XmlBeanDefinitionReader(context).loadBeanDefinitions("core/beanInstantiation.xml");
        context.refresh();
